...
<script>
// 권한(학생, 교직원, 부모)에 따라 마이 페이지 경로 변경
...
<!-- 학생 권한 header시작 -->
<sec:authorize access="hasRole('A01001')">
	<div class="header-top-area" style="background: #ffd966e0; backdrop-filter: blur(4px); -webkit-backdrop-filter: blur(4px); border: 1px solid rgba(255, 255, 255, 0.18);height:65px;"> 
...
<!-- 교직원 권한 header시작 -->
<sec:authorize access="hasRole('A01002')">
	<div class="header-top-area"style="background: rgb(0 0 0/ 82%);  backdrop-filter: blur(4px); -webkit-backdrop-filter: blur(4px); border: 1px solid rgba(255, 255, 255, 0.18);height:65px;">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="header-top-wraper">
...
<!-- 학부모 권한 header시작 -->
<sec:authorize access="hasRole('A01003')">
	<div class="header-top-area" style="background: rgb(0 112 255 / 88%); backdrop-filter: blur( 4px );-webkit-backdrop-filter: blur( 4px );border: 1px solid rgba( 255, 255, 255, 0.18 );height:65px;">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="header-top-wraper">
